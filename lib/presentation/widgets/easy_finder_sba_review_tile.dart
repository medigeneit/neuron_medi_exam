...
class EasyFinderSBAReviewTile extends StatefulWidget {
  final String indexLabel;
  final String titleHtml;
  final List<EasyFinderOption> options; // A..E
  ...
  @override
  State<EasyFinderSBAReviewTile> createState() => _EasyFinderSBAReviewTileState();
}

class _EasyFinderSBAReviewTileState extends State<EasyFinderSBAReviewTile> {
  ...
  @override
  void didUpdateWidget(covariant EasyFinderSBAReviewTile oldWidget) {
          ...
          children: [
            ...
            ...List.generate(widget.options.length, (i) {
              ...
              final bool correctSelected =
                  _showAnswer && key.isNotEmpty && (key == correctKey);
