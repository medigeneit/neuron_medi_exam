...
class EasyFinderMCQReviewTile extends StatefulWidget {
  final String indexLabel;
  final String titleHtml;
  final List<EasyFinderOption> options;
  final String? answerScript; // e.g. "TFTFF"
  final int? questionId;
  final Color blobColor;

  final bool showAllAnswers;

  const EasyFinderMCQReviewTile({
    super.key,
  ...
  @override
  State<EasyFinderMCQReviewTile> createState() => _EasyFinderMCQReviewTileState();
}

class _EasyFinderMCQReviewTileState extends State<EasyFinderMCQReviewTile> {
  ...
  @override
  void didUpdateWidget(covariant EasyFinderMCQReviewTile oldWidget) {
  ...
  Widget _statementRow(BuildContext context, EasyFinderOption opt, bool? correct) {
