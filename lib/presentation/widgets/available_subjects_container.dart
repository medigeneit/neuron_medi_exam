...
class AvailableSubjectsContainer extends StatefulWidget {
  ...
  const AvailableSubjectsContainer({
    Key? key,
    required this.items,
    this.padding = const EdgeInsets.all(16),
    this.borderRadius = 20,
    this.borderColor = AppColor.primaryColor,
    this.title = 'Available Subjects',
    this.subtitle,
  }) : super(key: key);

  @override
  State<AvailableSubjectsContainer> createState() => _AvailableSubjectsContainerState();
}

class _AvailableSubjectsContainerState extends State<AvailableSubjectsContainer> {
                        ...
                        if (widget.items.isNotEmpty)
                          GestureDetector(
                            onTap: () {
                              ...
                              debugPrint('See All Subjects clicked');
                            },
                            child: Container(
