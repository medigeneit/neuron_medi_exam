...
class DoctorScheduleService {
  ...
  Future<NetworkResponse> fetchDoctorSchedule(String admissionId) async {
    final url = Urls.doctorSchedule(admissionId);
    ...
    if (response.isSuccess && response.responseData != null) {
      try {
        ...
        if (response.responseData is Map<String, dynamic>) {
          final model = DoctorScheduleModel.fromJson(
        ...
        return NetworkResponse(
          statusCode: response.statusCode,
          isSuccess: false,
          errorMessage: "Failed to parse DoctorScheduleModel: $e",
        );
      }
    }
